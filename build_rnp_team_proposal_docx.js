// 科大讯飞致 RNP：RNP 侧项目人员配置参考（核心团队与岗位画像）—— 中文稿，供翻译为英文发 Iara
//   基准 v2：总部研发 9/15 20:52 版人数 + 陈昊指示（工作语言只留英语、标点统一）；本脚本即基准，供英文版复用
...
const GROUPS = [
  { name: "项目与产品", intro: "负责项目在 RNP 侧的组织、进度、资源与验收，以及国民 AI 应用的产品定义。工作从项目第一阶段开始。", roles: [
    { name: "项目经理", en: "Project Manager", c: 1, e: 1, one: "统筹 RNP 侧进度、资源与验收，对接科大讯飞与华为",
    ...
    { name: "产品经理", en: "Product Manager", c: 1, e: 1, one: "定义国民 AI 应用的功能、用户范围与内容规则",
  ...
  { name: "语料与数据资源", intro: "组织葡语语料的获取、授权、生产与质检，是项目第一阶段的主要力量。", roles: [
    { name: "数据资源工程师", en: "Data Resource Engineer", c: 2, e: 2, one: "寻找数据来源，落实授权，组织语料获取",
      req: ["熟悉巴西公开与机构数据资源：政府、高校、媒体、科研数据库", "懂数据授权与许可，能审阅来源许可条款", "有数据采集与整理经验，葡语母语；英语可作为工作语言"],
      col: ["对口科大讯飞数据团队：按语料规范确认来源与配额，收集并登记授权材料，提交 RNP 法务确认许可条件", "通过基础课程与跟岗学习，掌握数据源、许可与平台处理流程"] },
    { name: "数据质检工程师", en: "Data Quality Engineer", c: 2, e: 2, one: "执行语料的计数、抽样、质量阈值与复检规则",
      req: ["数据质量管理和抽样检查经验", "能理解数据格式、标注及质量规范", "能开展质量统计、缺陷分析和报告编制", "英语可作为工作语言"],
    ...
    { name: "标注员", en: "Annotator", c: 0, e: 100, one: "按规范完成文本标注、安全样本与语音转写",
      req: ["葡语母语，书面表达规范，细致稳定；英语可作为工作语言", "经培训后能按标注规范作业，转写岗位需良好的听写能力", "可以高校学生或阶段性人员为主，建议保留固定骨干"],
      col: ["使用双方确认的标注规范、样例与工具作业，配合科大讯飞在约定批次、抽样范围和复验轮次内开展质量复核"] },
  ] },
  { name: "葡语语言专家", intro: "定义巴西葡语的质量、标注与语音标准。建议核心 1 人牵头，其余专家可来自高校与研究机构。", roles: [
    { name: "语言专家", en: "Portuguese Language Expert", c: 1, e: 3, one: "制定葡语质量、标注规则、安全标签与语音标准",
      req: ["语言学、计算语言学或语音学背景", "熟悉巴西葡语的地区差异与当代用法", "有语料库或标注项目经验", "英语可作为工作语言"],
  ...
  { name: "模型与测试工程", intro: "在模型训练中心通过技术交流和约定的实操参与国家模型的训练与评测，并承担 RNP 负责的领域模型训练与评测；国家模型训练的合同责任分工不变。工作从项目第二阶段开始，是知识转移的核心受训对象。", roles: [
    { name: "NLP/DLM 算法工程师", en: "NLP/DLM Algorithm Engineer", c: 3, e: 0, one: "执行 RNP 承担的领域模型训练和实验，参与国家模型技术交流及效果分析",
      note: "建议其中 1 至 2 人参加在中国进行的持续预训练阶段工作",
      req: ["有 Python/C++/Java 等编程基础，Python 最佳", "有机器学习、自然语言处理、大模型等任一领域背景", "了解 Attention、GPT、Transformer 等大模型相关技术", "熟练使用 Transformers、PyTorch、Megatron 等深度学习/大模型框架", "有 LLM 预训练、后训练实际训练经验者优先"],
      col: ["对口科大讯飞模型团队：跟岗参与国家模型训练与评测，指导实操下自主提交作业", "领域模型由 RNP 训练，科大讯飞提供顾问支持"] },
    { name: "ASR/TTS 算法工程师", en: "ASR/TTS Algorithm Engineer", c: 1, e: 1, one: "开展语音数据检查、模型测试和问题定位，支持语音能力验证",
      req: ["有 Python/C++ 等编程基础", "具备音频处理技术背景，熟悉常见音频格式、采样率、降噪、切分等常见处理方法", "熟悉 PyTorch 等深度学习框架，理解 ASR 或 TTS 原理及评测方法，了解 WER/CER、MOS、RTF 等常用指标", "了解 Whisper、ESPnet、FunASR、VITS、FireRedTTS、IndexTTS 等语音工具/模型者优先", "有 ASR/TTS 实际训练、调优或部署经验者优先"],
      col: ["对口科大讯飞语音模型团队，配合数据检查、服务调用及效果验证", "提供错误样例和复现信息，跟踪语音问题处理及回归结果"] },
    { name: "训练与推理工程师", en: "Training and Inference Engineer", c: 1, e: 1, one: "负责训练任务和推理验证的工程执行，处理资源、恢复及运行问题",
      req: ["有 Python/Shell/C++ 等编程基础", "熟悉 Linux、容器（Docker/K8s）和 GPU 集群环境", "熟悉 PyTorch、Transformers、Megatron、DeepSpeed、vLLM、SGLang、TensorRT-LLM、Triton 等框架者优先", "熟悉分布式训练、资源调度、Checkpoint 恢复、任务重提、监控告警与日志分析", "熟悉大模型训练加速和推理加速技术者优先，包括但不限于 DP/EP/CP/PP 等训练并行方法，PD 分离、PagedAttention、KV Cache 管理、Speculative Decoding、量化等技术", "有大规模分布式训练、推理部署、集群运维或 AI 平台经验者优先"],
      col: ["对口科大讯飞模型及平台团队，参与任务配置、资源检查和训练推理验证", "执行 RNP 负责的工程操作，提供日志及环境信息，配合复杂问题定位"] },
    { name: "模型评测工程师", en: "Model Evaluation Engineer", c: 1, e: 1, one: "管理独立评测集，执行效果、安全及回归测试并形成可复核结果",
      req: ["有 Python 编程基础", "熟悉独立评测集及数据隔离要求，理解评测集与训练数据隔离、防污染/防泄漏", "掌握基线比较、指标分析和结果复现方法，能输出评测报告并定位效果差异", "了解常见评测基准与指标（如 MMLU、GSM8K、HumanEval、C-Eval、BLEU、ROUGE、WER 等）者优先", "熟悉 LM Evaluation Harness、OpenCompass 等评测框架者优先", "有模型评测经验者优先"],
      col: ["对口科大讯飞模型评测人员，确认测试集、参数、指标和结果记录方式", "执行 RNP 侧评测及独立复核，提交差异样例并配合回归验证"] },
    { name: "平台/API/应用测试工程师", en: "Platform, API and Application Test Engineer", c: 2, e: 1, one: "验证平台、接口和多终端应用功能，跟踪缺陷并提供验收证据",
  ...
  { name: "应用与运营", intro: "承担国民 AI 应用与 RNP 系统的集成、用户审批、内容与日常运营，并维护已交付且授权修改的代码。工作从项目第三阶段开始。", roles: [
    { name: "软件开发工程师", en: "Software Developer", c: 2, e: 2, one: "集成国民 AI 应用与 RNP 系统，开发本地内容与功能",
    ...
    { name: "运营工程师", en: "Application Operations Engineer", c: 2, e: 3, one: "运营应用：配置、用户审批、API 凭证与用量分析",
...
D.push(new Paragraph({ spacing: { after: 320 }, children: [R("科大讯飞提交 RNP 参考　·　2026 年 9 月 15 日", { size: 18, color: GRAY })] }));
...
P(`**扩展团队（Equipe complementar）${EXT} 人。** 承担语料生产、领域与语言专业支持、应用本地化开发与运营等阶段性、工作量集中的任务，随相应的工作阶段参与。建议每一类扩展团队岗位对应一个核心团队岗位作为对接负责人，以保证工作的连续性和成果的沉淀。扩展团队人员可考虑通过科研项目、阶段性合同以及高校和合作机构的参与来配置：语料标注等工作量大的岗位适合以高校学生和阶段性人员为主；语言专家和领域专家适合由高校和专业机构的专家参与。`);
...
H1("三、岗位画像");
P("每个岗位两部分：", { after: 20 });
P("**人员要求**说明该岗位需要什么样的人；", { after: 20 });
P("**协作方式**说明该岗位在项目中对口科大讯飞的哪支团队、以什么方式共同工作。编号与总览表一致，标题右侧为建议的核心与扩展人数。", { after: 60 });
