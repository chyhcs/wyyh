...
//   Source of truth: the Chinese baseline approved on 2026-09-15 (build_rnp_team_proposal_docx.js / the baseline docx).
//   Same structure, same numbers (core 43 / extended 68 / total 111, 8 groups, 26 roles); professional translation.
...
const GROUPS = [
  { name: { en: "Project and Product", pt: "Projeto e Produto" },
    ...
    roles: [
      { name: { en: "Project Manager", pt: "Gerente de Projeto" }, en: "Project Manager", c: 2, e: 0,
      ...
      { name: { en: "Product Manager", pt: "Gerente de Produto" }, en: "Product Manager", c: 2, e: 1,
  ...
  { name: { en: "Corpus and Data Resources", pt: "Corpus e Recursos de Dados" },
    ...
    roles: [
      { name: { en: "Data Resource Engineer", pt: "Engenheiro de Recursos de Dados" }, en: "Data Resource Engineer", c: 2, e: 2,
        ...
        req: { en: ["Familiar with Brazilian public and institutional data resources: government, universities, media and research databases", "Understands data licensing; able to review source licence terms", "Experience in data collection and curation; native Portuguese speaker"],
               pt: ["Familiaridade com recursos de dados públicos e institucionais brasileiros: governo, universidades, mídia e bases de pesquisa", "Conhece licenciamento de dados; capaz de analisar os termos de licença das fontes", "Experiência em coleta e organização de dados; falante nativo de português"] },
      ...
      { name: { en: "Data Quality Engineer", pt: "Engenheiro de Qualidade de Dados" }, en: "Data Quality Engineer", c: 2, e: 2,
        ...
        req: { en: ["Experience in data quality management and sample inspection", "Understands data formats, annotation and quality specifications", "Able to produce quality statistics, defect analysis and reports"],
               pt: ["Experiência em gestão da qualidade de dados e inspeção por amostragem", "Compreende formatos de dados, anotação e especificações de qualidade", "Capaz de produzir estatísticas de qualidade, análise de defeitos e relatórios"] },
      ...
      { name: { en: "Annotator", pt: "Anotador" }, en: "Annotator", c: 0, e: 20,
  ...
  { name: { en: "Portuguese Language Experts", pt: "Especialistas em Língua Portuguesa" },
    ...
    roles: [
      { name: { en: "Portuguese Language Expert", pt: "Especialista em Língua Portuguesa" }, en: "Portuguese Language Expert", c: 1, e: 5,
        ...
        req: { en: ["Background in linguistics, computational linguistics or phonetics", "Familiar with regional variation and contemporary usage of Brazilian Portuguese", "Experience in corpus or annotation projects"],
               pt: ["Formação em linguística, linguística computacional ou fonética", "Familiaridade com a variação regional e o uso contemporâneo do português brasileiro", "Experiência em projetos de corpus ou de anotação"] },
  ...
  { name: { en: "Model and Test Engineering", pt: "Engenharia de Modelos e Testes" },
    ...
    roles: [
      { name: { en: "NLP/DLM Algorithm Engineer", pt: "Engenheiro de Algoritmos de PLN/DLM" }, en: "NLP/DLM Algorithm Engineer", c: 6, e: 0,
        ...
        req: { en: ["Proficient in Python and mainstream deep learning frameworks", "Understands fine-tuning, data mixing ratios and experiment design", "Able to analyse training logs and model performance; hands-on training experience preferred"],
               pt: ["Proficiência em Python e nos principais frameworks de aprendizado profundo", "Compreende ajuste fino, proporções de mistura de dados e desenho de experimentos", "Capaz de analisar logs de treinamento e desempenho de modelos; experiência prática em treinamento é um diferencial"] },
      ...
      { name: { en: "ASR/TTS Algorithm Engineer", pt: "Engenheiro de Algoritmos de ASR/TTS" }, en: "ASR/TTS Algorithm Engineer", c: 0, e: 2,
        ...
        req: { en: ["Audio processing and speech data inspection skills", "Understands ASR or TTS principles and evaluation methods", "Able to call models, run tests and reproduce issues"],
               pt: ["Habilidades em processamento de áudio e inspeção de dados de fala", "Compreende os princípios e os métodos de avaliação de ASR ou TTS", "Capaz de invocar modelos, executar testes e reproduzir problemas"] },
      ...
      { name: { en: "Training and Inference Engineer", pt: "Engenheiro de Treinamento e Inferência" }, en: "Training and Inference Engineer", c: 3, e: 1,
        ...
        req: { en: ["Familiar with Linux, containers and distributed training environments", "Skilled in resource configuration, checkpoint recovery and job resubmission", "Able to configure inference, analyse logs and troubleshoot runtime issues"],
               pt: ["Familiaridade com Linux, contêineres e ambientes de treinamento distribuído", "Domínio de configuração de recursos, recuperação de checkpoints e ressubmissão de jobs", "Capaz de configurar inferência, analisar logs e diagnosticar problemas de execução"] },
      ...
      { name: { en: "Model Evaluation Engineer", pt: "Engenheiro de Avaliação de Modelos" }, en: "Model Evaluation Engineer", c: 2, e: 1,
        ...
        req: { en: ["Able to write or maintain evaluation scripts", "Familiar with independent evaluation sets and data isolation requirements", "Skilled in baseline comparison, metric analysis and result reproduction"],
               pt: ["Capaz de escrever ou manter scripts de avaliação", "Familiaridade com conjuntos de avaliação independentes e requisitos de isolamento de dados", "Domínio de comparação com linhas de base, análise de métricas e reprodução de resultados"] },
      ...
      { name: { en: "Platform, API and Application Test Engineer", pt: "Engenheiro de Testes de Plataforma, API e Aplicação" }, en: "Platform, API and Application Test Engineer", c: 0, e: 3,
  ...
  { name: { en: "Application and Operations", pt: "Aplicação e Operações" },
    ...
    roles: [
      { name: { en: "Software Developer", pt: "Desenvolvedor de Software" }, en: "Software Developer", c: 4, e: 11,
      ...
      { name: { en: "Application Operations Engineer", pt: "Engenheiro de Operações da Aplicação" }, en: "Application Operations Engineer", c: 3, e: 7,
...
function H3(num, name, en, c, e, note) {
  ...
  if (LANG === "pt" && en && en !== name) kids.push(R(`   ${en}`, { size: 18, color: GRAY }));
  kids.push(R(`\t${split(c, e)}`, { size: 20, bold: true, color: BLUE }));
  D.push(new Paragraph({ heading: HeadingLevel.HEADING_3, spacing: { before: 160, after: note ? 20 : 60 }, keepNext: true, tabStops: [{ type: TabStopType.RIGHT, position: PAGE_W }], children: kids }));
