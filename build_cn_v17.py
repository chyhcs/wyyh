# -*- coding: utf-8 -*-
"""
讯飞 × RNP 技术交流 PPT v17：11 页主汇报 + 问答目录页 + 13 页附录，基于华为简报模板。
...
用法：python3 build_cn_v17.py <template.pptx> <out.pptx>
"""
import sys
...
OUT = sys.argv[2] if len(sys.argv) > 2 else "RNP-讯飞交流-v17.pptx"
RNP_C = "1F4E79"
