# -*- coding: utf-8 -*-
"""
讯飞 × RNP 技术交流 PPT v10：11 页主汇报 + 问答目录页 + 12 页附录，基于华为简报模板。
...
用法：python3 build_cn_v10.py <template.pptx> <out.pptx>
"""
import sys
...
OUT = sys.argv[2] if len(sys.argv) > 2 else "RNP-讯飞交流-v10.pptx"
RNP_C = "1F4E79"
...
body(s, L + 0.25, 4.62, CW - 0.5, 0.58, "**知识转移**　两个轮次，合计 1216 课时、约 158 个工作日，累计学员名额 260 个　　**交付后支持**　现场陪伴 12 个月 + 远程支持 60 个月", size=12, valign="m")
body(s, L, 5.4, CW, 0.7, [
...
band(s, 5.2, 0.52, "知识转移", "每轮 608 课时、约 79 个工作日：奠基 60、跟岗 360、指导实操 20、正式移交 168 课时，每轮学员 50 / 20 / 20 / 40 人；实施两个轮次，合计 1216 课时、约 158 个工作日", fill=REDT, line=None, size=11)
